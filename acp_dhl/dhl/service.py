...
from resources.address import DHLPerson, DHLCompany
from resources.package import DHLPackage
from resources.shipment import DHLShipment
from resources.response import DHLShipmentResponse, DHLPodResponse, DHLTrackingResponse, DHLTrackingEvent
...
class DHLService:
    ...
    shipment_test_url = 'https://wsb.dhl.com:443/sndpt/expressRateBook?wsdl'
    shipment_url = 'https://wsbexpress.dhl.com/gbl/expressRateBook?wsdl'
    ...
    def send(self, shipment, message=None):
        ...
        if result_code == 500:
            try:
                return DHLPodResponse(False, errors=[reply.detailmessage])
    ...
    def _create_dhl_shipment(self, client, shipment):
        ...
        dhl_shipment.ShipmentInfo.Currency = shipment.currency[:3]
        dhl_shipment.ShipmentInfo.UnitOfMeasurement = shipment.unit[:2]
